...
func main() {
	...
	// Initialize routing and setup
	err := ipmanager.SetupRouting()
	if err != nil {
		log.Println("Failed to set up routing:", "err", err)
		return
	}
	...
	for {
		...
		err = ipmanager.RotateIP()
		if err != nil {
			log.Println("Error rotating IP:", "err", err)
		}
	}
}
